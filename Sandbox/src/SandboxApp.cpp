...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, +1.6f, -0.9f, +0.9f), m_CameraPosition(0.0f)
	{
		...
		std::string testureShaderFragmentSrc = R"(
			#version 330 core
		...
		m_TextureShader.reset(Hazel::Shader::Create(textureShaderVertexSrc, testureShaderFragmentSrc));
	...
	void OnUpdate(Hazel::Timestep ts) override
	{
		...
		std::dynamic_pointer_cast<Hazel::OpenGLShader>(m_FlatColorShader)->UploadUniformFloat3("u_Color", s_SquareColor);
...
private:
	...
	glm::vec3 s_SquareColor = { 0.2f, 0.3f, 0.8f };
};
